/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 81186723ab9f6490a8a374add4bc973f)
// Runtime types generated with workerd@1.20260828.1 2026-08-01 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SESSION: DurableObjectNamespace<import("./worker/index").SessionRoom>;
	DEVICE_GROUP: DurableObjectNamespace<import("./worker/index").DeviceGroup>;
	JOIN_GUARD: DurableObjectNamespace<import("./worker/index").JoinGuard>;
	METRICS: DurableObjectNamespace<import("./worker/index").Metrics>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "SessionRoom" | "JoinGuard" | "Metrics" | "DeviceGroup";
	}
